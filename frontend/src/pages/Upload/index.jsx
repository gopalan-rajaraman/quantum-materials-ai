                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="col-span-2 flex justify-center">
                            <div className="px-3.5 py-1.5 bg-green-50 text-green-700 font-bold text-[11px] rounded-lg border border-green-100 shadow-sm">
                              {exp.sampleCount}
                            </div>
                          </div>
                          ...
                          <div className="col-span-1 flex justify-end">
                            {isSelected ? (
                              <div className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 text-blue-700 rounded-full text-[11px] font-bold shadow-sm">
