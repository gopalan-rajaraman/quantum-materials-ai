              ...
              <div className="animate-fade-in flex flex-col h-full">
                {!showLockConfirmation ? (
                  <div className="flex flex-col items-center justify-center h-full flex-1 text-center">
                    ...
                    <div className="flex space-x-4">
                      ...
                      <button 
                        ...
                        className="px-8 py-3 bg-indigo-600 text-white rounded-xl font-medium hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200"
                      >
                        Review Experimental IDs
                      </button>
                    </div>
                  </div>
                ) : (
                  <div className="flex flex-col h-full">
                    <div className="mb-6">
                      <h2 className="text-2xl font-bold text-slate-900 mb-2">Confirm Experimental IDs</h2>
                    ...
                    <div className="flex-1 overflow-y-auto bg-slate-50 rounded-2xl border border-slate-200 p-4 mb-4">
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  <p className="font-semibold text-sm text-slate-900">EXP-{idx + 1}</p>
                                  <p className="text-xs text-slate-500 font-mono">{exp.id}</p>
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="flex justify-between items-center pt-4 border-t border-slate-200">
                      <button 
                        ...
                        className="px-6 py-2.5 bg-slate-100 text-slate-600 rounded-xl font-medium hover:bg-slate-200 transition-all"
                      >
                        Back
                      </button>
                      <button 
                        ...
                        className="flex items-center space-x-2 px-8 py-2.5 bg-indigo-600 text-white rounded-xl font-medium hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {isLocking ? (
                          <>
                          ...
                          <>
                            ...
                            <span>Lock Dataset ({confirmedExpIds.size} IDs)</span>
                          </>
                        )}
                      </button>
                    </div>
