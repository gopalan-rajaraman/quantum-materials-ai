...
import { 
  ...
  User, ChevronDown, ArrowRight, ChevronLeft, ChevronRight, Share2, Target, AlertCircle
} from 'lucide-react';
import { 
...
const Reports = () => {
  ...
  const recentReports = [
    ...
    { name: '2D_Materials_Study_Report', id: 'EXP-015', type: 'Experiment Summary', date: '13 May 2026, 09:15 AM', fwhm: '22.70 meV' },
    { name: 'Thin_Film_Analysis_Report', id: 'EXP-014', type: 'Experiment Summary', date: '12 May 2026, 02:05 PM', fwhm: '30.20 meV' },
  ];
        ...
        <div className="lg:w-[65%] flex flex-col space-y-6">
          <div className="bg-white rounded-xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-slate-100 p-6">
            ...
            <div className="grid grid-cols-4 gap-4 mb-8">
              <div className="border border-slate-100 rounded-xl p-4 flex items-center space-x-4 shadow-sm">
                <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-[#4C3BDE]">
                  <TrendingUp className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-[11px] font-bold text-slate-500 mb-0.5">Best FWHM Found</p>
                  <p className="text-lg font-bold text-[#00B050]">21.00 meV</p>
                </div>
              </div>
              <div className="border border-slate-100 rounded-xl p-4 flex items-center space-x-4 shadow-sm">
                <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-[#4C3BDE]">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-slate-800">10 / 10</p>
                </div>
              </div>
              <div className="border border-slate-100 rounded-xl p-4 flex items-center space-x-4 shadow-sm">
                <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-[#4C3BDE]">
              ...
              <div className="w-[30%]">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                    ...
                    <p className="text-[16px] font-bold text-[#4C3BDE]">91.7%</p>
                  </div>
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                    <p className="text-[11px] font-bold text-slate-500 mb-1">MAE</p>
                    <p className="text-[16px] font-bold text-[#00B050]">2.1 meV</p>
                  </div>
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                    <p className="text-[11px] font-bold text-slate-500 mb-1">RMSE</p>
                    <p className="text-[16px] font-bold text-[#3B82F6]">3.4 meV</p>
                  </div>
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                    <p className="text-[11px] font-bold text-slate-500 mb-1">Total Training Rows</p>
                    <p className="text-[16px] font-bold text-[#8B5CF6]">120</p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-slate-100 p-6">
            ...
            <div className="flex items-center justify-between mt-6 pt-4 border-t border-slate-100">
              <span className="text-[12px] font-medium text-slate-500">Showing 1 to 5 of 18 reports</span>
              <div className="flex space-x-1">
                ...
                <button className="w-8 h-8 flex items-center justify-center rounded border border-slate-200 text-slate-600 hover:bg-slate-50 text-[13px] font-bold">4</button>
            ...
            <div className="space-y-6 mb-6">
              <div className="flex items-start space-x-4">
                ...
                <p className="text-[13px] text-slate-700 leading-snug font-medium">
                  The model achieved its best FWHM of <span className="text-[#00B050] font-bold">21.00 meV</span> at iteration 8.
                </p>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-8 h-8 rounded-full bg-red-50 flex items-center justify-center text-red-500 flex-shrink-0 mt-0.5">
                  <TrendingUp className="w-4 h-4 transform rotate-180" />
                </div>
                <p className="text-[13px] text-slate-700 leading-snug font-medium">
                  Reducing Growth Temperature by ~20°C and Pressure by ~2 Torr had the most impact.
                </p>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-8 h-8 rounded-full bg-[#EBF4FF] flex items-center justify-center text-[#3B82F6] flex-shrink-0 mt-0.5">
                ...
                <p className="text-[13px] text-slate-700 leading-snug font-medium">
                  The surrogate model shows high reliability with R² score of <span className="font-bold">91.7%</span>.
                </p>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-8 h-8 rounded-full bg-[#E8FFF3] flex items-center justify-center text-[#00B050] flex-shrink-0 mt-0.5">
                  <AlertCircle className="w-4 h-4" />
                </div>
                <p className="text-[13px] text-slate-700 leading-snug font-medium">
                  Consider exploring narrower ranges around the best parameters for fine-tuning.
                </p>
              </div>
            </div>

            <button className="w-full py-3 bg-[#F8F6FF] text-[#4C3BDE] rounded-xl font-bold text-[13px] hover:bg-[#F0EBFF] transition-colors flex items-center justify-center space-x-2">
            ...
            <div className="space-y-5 mb-8">
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1 grid grid-cols-2">
                  ...
                  <span className="text-[12px] font-semibold text-slate-800">16 May 2026, 10:45 AM</span>
                </div>
              </div>
              <div className="flex items-start">
                <div className="w-6 h-6 rounded flex items-center justify-center bg-[#F4F0FF] text-[#4C3BDE] mr-3 mt-0.5">
                ...
                <div className="flex-1 grid grid-cols-2">
                  ...
                  <span className="text-[12px] font-semibold text-slate-800">Khushboo (Researcher)</span>
                </div>
              </div>
              <div className="flex items-start">
                <div className="w-6 h-6 rounded flex items-center justify-center bg-[#F4F0FF] text-[#4C3BDE] mr-3 mt-0.5">
                ...
                <div className="flex-1 grid grid-cols-2">
                  ...
                  <span className="text-[12px] font-semibold text-slate-800">Perovskite_PL_Study Dataset</span>
                </div>
              </div>
              <div className="flex items-start">
                <div className="w-6 h-6 rounded flex items-center justify-center bg-[#F4F0FF] text-[#4C3BDE] mr-3 mt-0.5">
