...
const AppLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F5F6FA] text-slate-900 flex font-sans print:bg-white print:block">
      <Sidebar />
      <main className={`flex-1 overflow-y-auto bg-[#F5F6FA] ${location.pathname === '/' ? 'p-0' : 'p-0 lg:p-0'} print:bg-white print:p-0 print:m-0 print:overflow-visible flex flex-col`}>
        {location.pathname !== '/' && !isAuthPage && <Header />}
        <div className={`flex-1 ${location.pathname === '/' ? '' : 'p-8 pt-6 lg:p-10 lg:pt-6'}`}>
          <Routes>
